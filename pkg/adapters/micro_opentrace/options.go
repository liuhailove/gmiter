...
type (
	...
	options struct {
		...
		// 客户端调用wrapper，主要用于灰度时的client构造
		clientCallWraps []client.CallWrapper
...
func WithClientCallWrapper(callWrappers ...client.CallWrapper) Option {
	return func(opts *options) {
		opts.clientCallWraps = callWrappers
	}
}
