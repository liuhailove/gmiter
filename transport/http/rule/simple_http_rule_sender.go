...
var (
	...
	WeightRouterRuleTypeCurrentVersion = "v_0"
...
func (s simpleHttpRuleSender) SetRuleTypeCurrentVersion(ruleType int32, version string) {
	...
	case WeightRouterRuleType:
		WeightRouterRuleTypeCurrentVersion = version
	default:
	}
}
...
func (s simpleHttpRuleSender) GetRuleTypeCurrentVersion(ruleType int32) string {
	...
	case WeightRouterRuleType:
		return WeightRouterRuleTypeCurrentVersion
	default:
		return "v_0"
	}
}
...
func GetRulesCurrentVersionStr() string {
	...
	currentVersionStr += "WeightRouterRuleType" + ":" + WeightRouterRuleTypeCurrentVersion + "\r\n"
...
func (s simpleHttpRuleSender) Rest2ImpossibleVersion() {
	...
	WeightRouterRuleTypeCurrentVersion = "v_00"
}

// RuleTypes 返回规则类
func (s simpleHttpRuleSender) RuleTypes() []int32 {
	return []int32{FlowRuleType, DegradeRuleType, HotParamRuleType, MockRuleType, SystemRuleType, RetryRuleType, GrayRuleType, IsolationRuleType, WeightRouterRuleType}
}
...
func (s simpleHttpRuleSender) BeforeStart() {
	...
	ruleTypeKeyMap[WeightRouterRuleType] = "weightRouter"
...
func (s simpleHttpRuleSender) FindRule(ruleType int32) (string, error) {
	...
	case WeightRouterRuleType:
		data, err = s.FetchData(config.QueryAllWeightRouterRuleApiPath())
	default:
	}
	if err != nil {
		return "", err
...
func (s simpleHttpRuleSender) HandleRule(ruleType int32, data string) error {
	...
	switch ruleType {
	case FlowRuleType, DegradeRuleType, SystemRuleType, AuthorityRuleType, IsolationRuleType, WeightRouterRuleType:
...
func (s simpleHttpRuleSender) FetchData(apiPath string) ([]byte, error) {
	...
	if response.GetStatusCode() == OkStatus {
		...
		return nil, errors.New("Http fetch data error")
	}
	return nil, nil
}
